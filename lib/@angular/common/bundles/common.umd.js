...
var NgClass = (function () {
    ...
    Object.defineProperty(NgClass.prototype, "ngClass", {
        ...
        set: function (v) {
            ...
            if (this._rawClass) {
                if (_angular_core.ÉµisListLikeIterable(this._rawClass)) {
    ...
    NgClass.prototype._applyIterableChanges = function (changes) {
        ...
        changes.forEachAddedItem(function (record) {
            if (typeof record.item === 'string') {
                ...
                throw new Error("NgClass can only toggle CSS classes expressed as strings, got " + _angular_core.Éµstringify(record.item));
            }
        });
...
function invalidPipeArgumentError(type, value) {
    return Error("InvalidPipeArgument: '" + value + "' for pipe '" + _angular_core.Éµstringify(type) + "'");
}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
...
var AsyncPipe = (function () {
    ...
    AsyncPipe.prototype._selectStrategy = function (obj) {
        if (_angular_core.ÉµisPromise(obj)) {
            return _promiseStrategy;
        }
        if (_angular_core.ÉµisObservable(obj)) {
...
exports.ÉµPLATFORM_BROWSER_ID = PLATFORM_BROWSER_ID;
exports.ÉµPLATFORM_SERVER_ID = PLATFORM_SERVER_ID;
exports.ÉµPLATFORM_WORKER_APP_ID = PLATFORM_WORKER_APP_ID;
exports.ÉµPLATFORM_WORKER_UI_ID = PLATFORM_WORKER_UI_ID;
...
exports.Éµa = COMMON_DIRECTIVES;
exports.Éµb = COMMON_PIPES;
